...
const contactInfo = [];
graduates.forEach((y) => contactInfo.push(`${y.first_name} ${y.email}`))
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = graduates.filter((z) => z.university.includes("Uni"))
console.log(uni);
...
*/
const animalNames = [];
  zooAnimals.forEach((names) => animalNames.push(`${names.animal_name}, ${names.scientific_name}`))
